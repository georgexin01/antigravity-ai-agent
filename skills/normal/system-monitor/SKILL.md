...
1. **Multi-Project Pulse Scan**: Executes `scripts/system_health_check.ps1` to verify `node_modules`, `dist`, and `git` status across all folders.
2. **Dashboard Sync**: Proactively updates the `antigravity_dashboard_v2.html` with real-time health data points.
3. **Anomaly Detection**: Identifies missing `.geminiignore` or unexpected file growth.
...
_Skill Manifest V1.0 — Antigravity Vigilance (2026-04-06)_
