...
page: dashboard
status: designing
next_action: list_screens
---
# Mission: Build SaaS Dashboard
The design system (DESIGN.md) is already established. 
...
2. **DESIGN**: Stitch creates the visual "DNA" (`DESIGN.md`) and initial UI screens.
3. **BATON PASS**: The agent writes the current state and next goal to `.stitch/next-prompt.md`.
