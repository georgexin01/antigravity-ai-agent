...
## 🏗️ 5. Project DNA (The DESIGN.md Concept)
For large-scale projects, **Image DNA** is scaled into a **Project DNA** file, commonly named `DESIGN.md`. This serves as the **Single Source of Truth**.
...
2. **DNA Inject**: Pull the project's visual style from `DESIGN.md`.
