---
name: loop-manager
description: "Sovereign Loop Manager (V30.0 Elite)"
triggers: ["loop manager", "loop_manager", "sovereign loop manager"]
phase: reference
...
Identity: SOVEREIGNELITEV30.0 (Loop Master)
...
| :--- | :--- | :--- | :--- |
| FaucetDone | `PTCCount > 0` | Navigate to `/ptc` | SM-03 |
| PTCDone | `PlatformB_Ready = True` | Navigate to `onlyfaucet.com` | SM-01 |
| RAMCritical | `FreePhys < 4GB` | Enter Safe Buffer Mode | SM-02 |
| AllSitesLock| `Wait_Time > 10m` | Silent SBP Audit of Session | SBP |
...
---
V30.0 Sovereign Elite Loop Manager — Zero-Token Flow Active (2026-04-09)
